...
$(document).delegate('#button-seller_add_image', 'click', function() {
	$.ajax({
		url: 'index.php?route=seller/seller/seller_add_image&token=<?php echo $token; ?>&seller_id=<?php echo $seller_id; ?>',
		dataType: 'json',
...
$(document).delegate('#button-seller_delete_image', 'click', function() {
	$.ajax({
		url: 'index.php?route=seller/seller/seller_delete_image&token=<?php echo $token; ?>&seller_id=<?php echo $seller_id; ?>',
		dataType: 'json',
		data: 'seller_image=' + encodeURIComponent($('#tab-seller input[name=\'image\']').val()),
		beforeSend: function() {
...
$(document).delegate('#button-facebook', 'click', function() {
	$.ajax({
		url: 'index.php?route=seller/seller/facebook&token=<?php echo $token; ?>&seller_id=<?php echo $seller_id; ?>',
		dataType: 'json',
...
$(document).delegate('#button-twitter', 'click', function() {
	$.ajax({
		url: 'index.php?route=seller/seller/twitter&token=<?php echo $token; ?>&seller_id=<?php echo $seller_id; ?>',
		dataType: 'json',
...
$(document).delegate('#button-googleplus', 'click', function() {
	$.ajax({
		url: 'index.php?route=seller/seller/googleplus&token=<?php echo $token; ?>&seller_id=<?php echo $seller_id; ?>',
		dataType: 'json',
...
$(document).delegate('#button-instagram', 'click', function() {
	$.ajax({
		url: 'index.php?route=seller/seller/instagram&token=<?php echo $token; ?>&seller_id=<?php echo $seller_id; ?>',
		dataType: 'json',
