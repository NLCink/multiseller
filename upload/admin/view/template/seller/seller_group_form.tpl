  ...
  <tbody>
    <?php if ($commissions) { ?>
            ...
            <div class="col-sm-10">
              ...
              <div class="checkbox">
                <label>
                  <?php if (in_array($commission['commission_id'], $seller_group_commission)) { ?>
                  <input type="checkbox" name="seller_commission[]" value="<?php echo $commission['commission_id']; ?>" checked="checked" />
               
                  <?php echo $commission['title']; ?>
                  <?php } else { ?>
                  <input type="checkbox" name="seller_commission[]" value="<?php echo $commission['commission_id']; ?>" />
