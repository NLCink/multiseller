...
$(document).delegate('#button-invoice', 'click', function() {
	$.ajax({
		url: 'index.php?route=seller/order/createinvoiceno&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>',
		dataType: 'json',
		beforeSend: function() {
...
$('#button-sellerhistory').on('click', function() {
  if(typeof verifyStatusChange == 'function'){
	...
	$.ajax({
		url: '<?php echo $store_url; ?>index.php?route=api/order/sellerhistory&token=' + token + '&order_id=<?php echo $order_id; ?>&seller_id=<?php echo $seller_id; ?>',
		type: 'post',
		dataType: 'json',
