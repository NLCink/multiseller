      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-sellerreview" class="form-horizontal">
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-seller_name"><?php echo $entry_seller_name; ?></label>
            <div class="col-sm-10">
              <input type="text" name="seller_name" value="<?php echo $seller_name; ?>" placeholder="<?php echo $entry_seller_name; ?>" id="input-seller_name" class="form-control" />
              <?php if ($error_seller_name) { ?>
              <div class="text-danger"><?php echo $error_seller_name; ?></div>
              <?php } ?>
            </div>
          </div>
          <div class="form-group required">
