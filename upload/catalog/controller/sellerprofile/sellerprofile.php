...
if (isset($this->request->post['seller_group_subscription_price'])) {
	...
	$data['text_unlimited'] = $this->language->get('text_unlimited');
		...
		$seller_groups_results = $this->model_sellerprofile_sellerprofile->getsellerGroups();
	
				
		$data['request_memberships'] = array();
		
		foreach ($seller_groups_results as $seller_groups_result) {
			$data['request_memberships'][] = array(
			'seller_group_id'      => $seller_groups_result['seller_group_id'],
				'seller_group'      => $seller_groups_result['name'],
				'subscription_price'      => $this->currency->format($seller_groups_result['subscription_price']), 				
				'product_limit'      => $seller_groups_result['product_limit'],
				'seller_group_commission' => $this->model_sellerprofile_sellerprofile->getsellerGroupCommission($seller_groups_result['seller_group_id']),
				'seller_group_commission_rate' => $this->currency->format($this->model_sellerprofile_sellerprofile->getsellerGroupCommissionRate($seller_groups_result['seller_group_id']))
	...
	if (isset($this->request->get['sort'])) {
		...
		$data['seller_categories'] = $this->model_sellerproduct_category->getCategories(array('sort' => 'name'));
		...
		foreach ($results as $result) {
			$data['seller_groups'][] = array(
				...
				'seller_group_commission' => $this->model_sellerprofile_sellerprofile->getsellerGroupCommission($result['seller_group_id']),
				'categories'		=> $this->model_sellerproduct_product->getsellergroupCategories($result['seller_group_id']),
				'seller_group_commission_rate' => $this->currency->format($this->model_sellerprofile_sellerprofile->getsellerGroupCommissionRate($result['seller_group_id']))
